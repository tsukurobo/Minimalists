...
int main(void) {
    ...
    static const trajectory_waypoint_t all_waypoints[WAYPOINT_NUM] = {
        ...
        trajectory_waypoint_t(3.639f, -0.261f / Mech::gear_radius_P, 150.066f, 5769, Traj::PassThroughMode::INTERMEDIATE_12),                         // ID: 1-8
        ...
        trajectory_waypoint_t(3.232f, -0.185f / Mech::gear_radius_P, 174.066f, 5863, Traj::PassThroughMode::INTERMEDIATE_12),                         // ID: 1-6
        ...
        trajectory_waypoint_t(4.026f, -0.343f / Mech::gear_radius_P, 128.879f, 5648, Traj::PassThroughMode::INTERMEDIATE_12),                         // ID: 2-10
        ...
        trajectory_waypoint_t(4.842f, -0.079f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-1
        trajectory_waypoint_t(4.205f, -0.146f / Mech::gear_radius_P, 119.209f, 5524, Traj::PassThroughMode::INTERMEDIATE_2),                          // ID: 4-9
        trajectory_waypoint_t(4.897f, -0.080f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-2
        trajectory_waypoint_t(4.009f, -0.017f / Mech::gear_radius_P, 129.231f, 5680, Traj::PassThroughMode::INTERMEDIATE_1),                          // ID: 4-8
        trajectory_waypoint_t(4.945f, -0.081f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-3
        trajectory_waypoint_t(3.812f, 0.052f / Mech::gear_radius_P, 139.956f, 5736, Traj::PassThroughMode::INTERMEDIATE_1),                           // ID: 4-7
        trajectory_waypoint_t(4.964f, -0.094f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-4
        trajectory_waypoint_t(3.329f, 0.118f / Mech::gear_radius_P, 168.176f, 5762, Traj::PassThroughMode::INTERMEDIATE_1),                           // ID: 4-6
        trajectory_waypoint_t(5.032f, -0.104f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-5
        trajectory_waypoint_t(2.935f, 0.118f / Mech::gear_radius_P, 192.703f, 5779, Traj::PassThroughMode::INTERMEDIATE_1),                           // ID: 4-5
        trajectory_waypoint_t(5.092f, -0.113f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-6
        trajectory_waypoint_t(2.456f, 0.047f / Mech::gear_radius_P, 218.813f, 5773, Traj::PassThroughMode::INTERMEDIATE_1),                           // ID: 4-4
        trajectory_waypoint_t(5.148f, -0.124f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-7
        trajectory_waypoint_t(2.261f, -0.018f / Mech::gear_radius_P, 229.099f, 5771, Traj::PassThroughMode::INTERMEDIATE_1),                          // ID: 4-3
        trajectory_waypoint_t(5.217f, -0.139f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-8
        trajectory_waypoint_t(2.074f, -0.139f / Mech::gear_radius_P, 240.264f, 5755, Traj::PassThroughMode::INTERMEDIATE_1),                          // ID: 4-2
        trajectory_waypoint_t(5.289f, -0.161f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-9
        trajectory_waypoint_t(2.001f, -0.235f / Mech::gear_radius_P, 246.945f, 5654, Traj::PassThroughMode::INTERMEDIATE_1),                          // ID: 4-1
        trajectory_waypoint_t(5.334f, -0.196f / Mech::gear_radius_P, 113.231f, Hand::LiftAngle::SHOOT_UP, Traj::PassThroughMode::INTERMEDIATE_1),     // ID: o-10
    };
#endif
