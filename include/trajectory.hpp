...
class trajectory_t {
   ...
   public:
     ...
     * @param end_pos 目標位置
     */
    trajectory_t(float max_vel, float max_accel, float start_pos, float end_pos);
     ...
     */
    void get_trapezoidal_state(float current_time, float *target_pos, float *target_vel, float *target_accel) const;
